...
#     path_reconstruct = column1.get_subfolder_path(part_index=i, folder_index=1)
#     path_roi = column1.get_subfolder_path(part_index=i, folder_index=2)
#     path_rename = column1.get_subfolder_path(part_index=i, folder_index=3)
#     path_processed = column1.get_subfolder_path(part_index=i, folder_index=4)
#     roi = column1.get_roi(part_index=i)
