...
if __name__ == "__main__":
    ...
    image_dir = r'/mnt/g/DL_Data_raw/version7-large-lowRH/8.Unlabeled/5.2Preprocessed'
    # label_dir = r'/mnt/g/DL_Data_raw/version7-large-lowRH/8.Unlabeled/6.2Precheck/'
    output_dir = r'/mnt/g/DL_Data_raw/version7-large-lowRH/8.Unlabeled/6.2Precheck'
