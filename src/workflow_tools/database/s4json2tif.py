...
if __name__ == '__main__':
    json_dir = Path(r'/mnt/g/DL_Data_raw/version9-low-precise/4.Converted/label-json')
    output_dir = Path(r'/mnt/g/DL_Data_raw/version9-low-precise/4.Converted/label-origin')
