...
if __name__ == "__main__":
    for i in [9]:
        ...
        image_dir = f'g:/3.Experimental_Data/Soils/Dongying_highRH/Soil.column.{i:04d}/2.ROI/'
        output_dir = f'g:/3.Experimental_Data/Soils/Dongying_highRH/Soil.column.{i:04d}/3.Harmonized/'
